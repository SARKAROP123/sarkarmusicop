...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", " SARKAR PLAYYER")
OWNER_ID = list(map(int, getenv("OWNER_ID", "6004468325").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "bikash")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/TKS_COME")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/TKS_CHAT_OFFICIAL")
...
LOG_FILE_NAME = "sarkar.txt"
############################


# All Images Of Bikash Aditya Player // @BIKASHHALDER @AdityaHalder
START_IMG_URL = getenv("START_IMG_URL", f"https://graph.org/file/c794bcf8fb01d903edbdf.jpg")
